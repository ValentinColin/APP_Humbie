...
<body>
	...
	<div class="wrapper">
        <h1 id="title">Results of my pilots:</h1>
        <form action="../../Controller/fluxTest.php" method="GET">
            <label for="nbrres">Number of results to display</label>
        ...
        <div class="test-box">   
            ...
            <div class="cell">
                <h3 class="sous-sous-titre">Acoustic frequency range</h3>
                <table id="table-main">
                    <th id = 'cell-value'>Unit: Hz</th>
                        <?php
