		...
		<div id="box-content" class="my-block">
			...
			<table>
				<tr>
					...
					<td class="strong-cell"><strong>DAT OF BIRTH:</strong> <?= $_SESSION['resultat_profil']['birthday_date'] ?></td> <!-- colonne 3 -->
			...
			<?php }elseif($_SESSION['access'] == 'MANAGER'){?>
				<form action="../../Controller/results.php" method="GET">
					<button id="button-profil-modifier" class="pull-right" name="id" value="<?= $_SESSION['resultat_profil']['id']?>">See the results of the tests performed</button> <!-- Ce bouton doit être placer avant le h2 à cause du float (à modifier plus tard) -->
				</form>
