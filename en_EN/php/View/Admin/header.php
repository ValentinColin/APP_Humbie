		...
		<form method="get" action="../../Controller/search_member_c.php/">
			...
			<div class="search">
				<select name="searchPeople" class="searchBar searchBar1">
					<option value='searchNom'> Search by lat name </option>
				...
				<input type='text' name="Serch here" class="searchBar searchBar2" placeholder="...">
			...
			<div id="header-profil-grid">
				...
				<span id="box-deconnexion">
					<form method="post" action="../../Controller/logout.php">
						<input id="button-deconnexion" type="submit" value="Submit">
					</form>
				</span>
			</div>
		</a>
