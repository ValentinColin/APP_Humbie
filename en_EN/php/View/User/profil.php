...
<body>
	...
	<div class="wrapper">
		...
		<div id="box-content" class="my-block">
			...
			<button id="button-profil-modifier" class="pull-right">Modify personnal information </button> <!-- Ce bouton doit être placer avant le h2 à cause du float (à modifier plus tard) -->
			</form>
