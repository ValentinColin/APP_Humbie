...
<body>
		...
		<div id="box-nav" class="my-block">
			<nav id='mainNav'>
				...
				<ul id="navigation">
					...
					<li><a href="../../../../html/building.html">Pilotes</a></li>
					<li><a href="../../../../html/building.html">Gestion des tickets</a></li>
	...
	<!-- <aside id="blank"></aside> --> <!-- Permet de bloquer le footer en bas de l'écran -->
