<form id='affinerRecherche' method='post' action='../../Controller/search_member_c.php/?search=AllMember'>
  ...
  oui <input name='triRole' type='radio' value='oui' <?php if ($_SESSION['triRole'] == "oui") : ?> title='tri déjà effectif' checked <?php endif ?>>
  non <input name='triRole' type='radio' value="non" <?php if ($_SESSION['triRole'] != "oui") : ?> title='tri déjà effectif' <?php endif ?>> <br>
