        ...
        <main>
            ...
            <form method="post" action="">
                <fieldset >
                    ...
                    <div width=1px height=4px class="wrapper">
                    <p id='confirm'> <input id='submit' type='submit' value='Se connecter'>


  <a class="cta" href="newPassword.php">
    <span>Réinitialiser mot de passe</span>
    <span id='special'>
      <svg width="10px" height="17px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
